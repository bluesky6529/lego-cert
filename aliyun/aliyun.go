...
func Aliyun_cert(account string, domain_name string) {
	...
	aliconfig := alidns.Config{
		APIKey:             viper.GetString("ALIYUN." + account + ".keyid"),
		SecretKey:          viper.GetString("ALIYUN." + account + ".keysecret"),
	...
	p, err := alidns.NewDNSProviderConfig(&aliconfig)
